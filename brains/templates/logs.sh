...
# /usr/bin/python -u /usr/local/bin/kalliope start | tee -a kalliope.log So that 
# logs are still displayed on standard output and in a log file Edit the audio 
# variable text to use the variable as needed. Kalliope will read the content of 
# the audio variable (output of the script)
