#!/usr/bin/python
# coding: utf-8
import argparse import commands from email.mime.text import MIMEText from 
subprocess import Popen, PIPE def main():
    configuration = {
    ...
    parser.add_argument("-b", "--body", help="Email body, used if -c is not 
present")
